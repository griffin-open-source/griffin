 ...
 * UnaryPredicate
 */
export type UnaryPredicate = 'IS_NULL' | 'IS_NOT_NULL' | 'IS_TRUE' | 'IS_FALSE' | 'IS_EMPTY' | 'IS_NOT_EMPTY';
...
export type BinaryPredicate = {
     ...
     */
    operator: 'EQUAL' | 'NOT_EQUAL' | 'GREATER_THAN' | 'LESS_THAN' | 'GREATER_THAN_OR_EQUAL' | 'LESS_THAN_OR_EQUAL' | 'CONTAINS' | 'NOT_CONTAINS' | 'STARTS_WITH' | 'ENDS_WITH' | 'NOT_STARTS_WITH' | 'NOT_ENDS_WITH';
};
 ...
 * Node
 */
export type Node = Endpoint | Wait | Assertions;
 ...
 * Assertion
 */
export type Assertion = JsonAssertion | XmlAssertion | TextAssertion;
...
export type JsonAssertion = {
    ...
    path: Array<string>;
    predicate: 'IS_NULL' | 'IS_NOT_NULL' | 'IS_TRUE' | 'IS_FALSE' | 'IS_EMPTY' | 'IS_NOT_EMPTY' | {
        expected: unknown;
        operator: 'EQUAL' | 'NOT_EQUAL' | 'GREATER_THAN' | 'LESS_THAN' | 'GREATER_THAN_OR_EQUAL' | 'LESS_THAN_OR_EQUAL' | 'CONTAINS' | 'NOT_CONTAINS' | 'STARTS_WITH' | 'ENDS_WITH' | 'NOT_STARTS_WITH' | 'NOT_ENDS_WITH';
    };
    assertionType: 'JSON';
 ...
 * SecretOrString
 */
export type SecretOrString = SecretRef | StringLiteral;
...
export type DeletePlanByIdError = DeletePlanByIdErrors[keyof DeletePlanByIdErrors];
...
export type DeletePlanByIdResponse = DeletePlanByIdResponses[keyof DeletePlanByIdResponses];
...
export type PutPlanByIdResponse = PutPlanByIdResponses[keyof PutPlanByIdResponses];
...
export type GetPlanByNameResponse = GetPlanByNameResponses[keyof GetPlanByNameResponses];
...
export type PostRunsTriggerByPlanIdError = PostRunsTriggerByPlanIdErrors[keyof PostRunsTriggerByPlanIdErrors];
...
export type PostRunsTriggerByPlanIdResponse = PostRunsTriggerByPlanIdResponses[keyof PostRunsTriggerByPlanIdResponses];
